...
print("\nAdd the semifunished,unfurnished columns to dataset")
data = pd.concat([data, dum], axis=1)
print(data[['semi-furnished','unfurnished']].head())
